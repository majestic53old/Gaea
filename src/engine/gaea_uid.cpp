	...
	namespace engine {
		...
		namespace uid {
			...
			_base::decrement_reference(void)
			{
				...
				if(gaea::engine::uid::manager::is_allocated()) {

					gaea::engine::uid::manager &instance = gaea::engine::uid::manager::acquire();
			...
			{
				return gaea::engine::uid::base::as_string(*this, verbose);
			}
			...
			_manager::_manager(void) :
				...
				m_next(UID_INIT)
			{
				std::atexit(gaea::engine::uid::manager::_delete);
			}
			...
			_manager::_delete(void)
			{
				...
				if(gaea::engine::uid::manager::m_instance) {
					delete gaea::engine::uid::manager::m_instance;
					gaea::engine::uid::manager::m_instance = nullptr;
				}
			}
			...
			_manager::acquire(void)
			{
				...
				if(!gaea::engine::uid::manager::m_instance) {
					...
					gaea::engine::uid::manager::m_instance = new gaea::engine::uid::manager;
					if(!gaea::engine::uid::manager::m_instance) {
						THROW_GAEA_UID_EXCEPTION(GAEA_UID_EXCEPTION_ALLOCATED);
					}
				}

				return *gaea::engine::uid::manager::m_instance;
			}
			...
			{
				return (gaea::engine::uid::manager::m_instance != nullptr);
			}
