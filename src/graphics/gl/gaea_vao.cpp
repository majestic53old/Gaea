	...
	namespace graphics {
		...
		namespace gl {
			...
			namespace vao {
				...
				_base::_base(void) :
					gaea::graphics::gl::base(GL_OBJECT_VAO)
				{
					return;
				}
					...
					)
				{
					...
					std::vector<gaea::graphics::gl::vbo::base>::const_iterator vbo_iter;

					result << gaea::graphics::gl::base::as_string(object, verbose)
					...
					if(!object.m_vbo.empty()) {
						...
						for(vbo_iter = object.m_vbo.begin(); vbo_iter != object.m_vbo.end();
							...
							result << gaea::graphics::gl::vbo::base::as_string(*vbo_iter, verbose);
						}
					...
					)
				{
					...
					m_vbo.push_back(gaea::graphics::gl::vbo::base(data, size, target, usage));
				...
				{
					return gaea::graphics::gl::vao::base::as_string(*this, verbose);
				}
			}
		}
	}
