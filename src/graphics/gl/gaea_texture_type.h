	...
	namespace graphics {
		...
		namespace gl {
			...
			namespace texture {
				...
				#define GAEA_TEXTURE_HEADER "[GAEA::GRAPHICS::GL::TEXTURE]"
#ifndef NDEBUG
				...
				enum {
					...
					GAEA_TEXTURE_EXCEPTION_INVALID,
					GAEA_TEXTURE_EXCEPTION_NOT_FOUND,
					GAEA_TEXTURE_EXCEPTION_UNSUPPORTED,
				};

				#define GAEA_TEXTURE_EXCEPTION_MAX GAEA_TEXTURE_EXCEPTION_UNSUPPORTED

				static const std::string GAEA_TEXTURE_EXCEPTION_STR[] = {
					GAEA_TEXTURE_EXCEPTION_HEADER "External exception",
					GAEA_TEXTURE_EXCEPTION_HEADER "Invalid parameter",
					GAEA_TEXTURE_EXCEPTION_HEADER "File does not exist",
					GAEA_TEXTURE_EXCEPTION_HEADER "Unsupported image type",
					};
