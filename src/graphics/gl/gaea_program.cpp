			...
			namespace program {
				...
				_base::_base(
					...
					__in_opt const std::vector<std::string> &attribute
						...
						gaea::graphics::gl::base(GL_OBJECT_PROGRAM)
				{
					...
					)
				{
					...
					std::vector<gaea::graphics::gl::shader::base> shader;
					std::vector<std::string>::const_iterator attrib_iter;
					std::vector<gaea::graphics::gl::shader::base>::iterator shader_iter;

					shader.push_back(gaea::graphics::gl::shader::base(vertex, GL_VERTEX_SHADER));
					GL_CHECK(glAttachShader, m_handle, shader.back().handle());
					shader.push_back(gaea::graphics::gl::shader::base(fragment, GL_FRAGMENT_SHADER));
					GL_CHECK(glAttachShader, m_handle, shader.back().handle());
				...
				{
					return gaea::graphics::gl::program::base::as_string(*this, verbose);
				}
