	...
	namespace graphics {
		...
		namespace gl {
			...
			_base::decrement_reference(void)
			{
				...
				if(gaea::graphics::gl::manager::is_allocated()) {

					gaea::graphics::gl::manager &instance = gaea::graphics::gl::manager::acquire();
			...
			{
				return gaea::graphics::gl::base::as_string(*this, verbose);
			}

			gaea::gl_type_t 
			_base::type(void)
			{
				return (gaea::gl_type_t) gaea::engine::object::base::subtype();
			}
			...
			_manager::_manager(void) :
				m_initialized(false)
			{
				std::atexit(gaea::graphics::gl::manager::_delete);
			}
			...
			_manager::_delete(void)
			{
				...
				if(gaea::graphics::gl::manager::m_instance) {
					delete gaea::graphics::gl::manager::m_instance;
					gaea::graphics::gl::manager::m_instance = nullptr;
				}
			}
			...
			_manager::acquire(void)
			{
				...
				if(!gaea::graphics::gl::manager::m_instance) {
					...
					gaea::graphics::gl::manager::m_instance = new gaea::graphics::gl::manager;
					if(!gaea::graphics::gl::manager::m_instance) {
						THROW_GAEA_GL_EXCEPTION(GAEA_GL_EXCEPTION_ALLOCATED);
					}
				}

				return *gaea::graphics::gl::manager::m_instance;
			}
			...
			{
				return (gaea::graphics::gl::manager::m_instance != nullptr);
			}
