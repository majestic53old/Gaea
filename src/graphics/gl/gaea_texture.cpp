			...
			namespace texture {
				...
				_base::_base(
					...
					__in_opt GLuint index
						...
						gaea::graphics::gl::base(GL_OBJECT_TEXTURE),
						m_index(index)
				{
					...
					)
				{
					...
					gaea::graphics::gl::texture::import(texture, type, data, dimensions, color, depth);
				...
				{
					return gaea::graphics::gl::texture::base::as_string(*this, verbose);
				}
			}
		}
	}
