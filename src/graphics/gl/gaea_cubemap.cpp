			...
			namespace cubemap {
				...
				_base::_base(
					...
					__in_opt GLuint index
						...
						gaea::graphics::gl::base(GL_OBJECT_CUBEMAP),
						m_index(index)
				{
					...
					)
				{
					...
					for(; iter < CUBEMAP_FACE_COUNT; ++iter) {
						gaea::graphics::gl::texture::import(face.at(iter), type, data, dimensions, color, depth);
				...
				{
					return gaea::graphics::gl::cubemap::base::as_string(*this, verbose);
				}
			}
		}
	}
